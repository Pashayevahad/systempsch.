...
const BusinessPsychology = () => {
    ...
    return (
        <section className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center p-6 bg-charcoal animate-fade-in" data-purpose="business-psychology-section">
            ...
            <div className="relative z-20 text-center max-w-4xl px-4">
                ...
                <div className={`transition-all duration-1000 ease-out transform ${showTitle ? 'opacity-100 translate-y-0 backdrop-blur-md bg-white/5 border border-white/10 p-8 rounded-2xl shadow-2xl' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-[-0.02em] text-white">
                        Transition: <br /><span className="italic font-serif font-medium text-white/90">From Realistic Boardroom to Technical Blueprint.</span>
                    </h1>
                </div>
            </div>
